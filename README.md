...
```bash
git clone https://github.com/YOUR_USERNAME/fruit-classifier-bot.git
cd fruit-classifier-bot
```
...
├── best_fruits_model.pth # Веса обученной модели (не включены в репозиторий)
├── requirements.txt
└── README.md
```
